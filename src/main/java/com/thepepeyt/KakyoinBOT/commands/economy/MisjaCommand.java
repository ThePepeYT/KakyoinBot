...
public class MisjaCommand extends ListenerAdapter {

    private JDA jda;

    public MisjaCommand(JDA jda) {
        this.jda = jda;
        System.out.println("MisjaCommand registered");
    }
    ...
    public void onSlashCommand(SlashCommandEvent e) {
        if (!e.getName().equals("misja")) return;
        User user = e.getUser();
